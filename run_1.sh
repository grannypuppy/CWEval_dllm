...
python cweval/generate_stage1_dream.py gen \
  ...
  --model_path "${MTAST_BASE}/checkpoint-1200" \
  --codedllm_root "${CODEDLLM_ROOT}" \
  --eval_path evals/eval_multitask_ast_bigvul_cm_ckpt1200_n4_4gpu-dream_mtast_cweval \
  --ppt direct \
  --num_proc 4 \
  --gpu_ids 0,1,2,3 \
  --langs py,c,cpp \
...
python cweval/generate_stage1_dream.py gen \
  --backend dream_multitask_ast \
  --model_path "${MTAST_BASE}/checkpoint-1300" \
  --codedllm_root "${CODEDLLM_ROOT}" \
  --eval_path evals/eval_multitask_ast_bigvul_cm_ckpt1300_n4_4gpu-dream_mtast_cweval \
  --ppt direct \
  --num_proc 4 \
  --gpu_ids 0,1,2,3 \
  --langs py,c,cpp \
...
python cweval/generate_stage1_dream.py gen \
  --backend dream_multitask_ast \
  --model_path "${MTAST_BASE}/checkpoint-1400" \
  --codedllm_root "${CODEDLLM_ROOT}" \
  --eval_path evals/eval_multitask_ast_bigvul_cm_ckpt1400_n4_4gpu-dream_mtast_cweval \
  --ppt direct \
  --num_proc 4 \
  --gpu_ids 0,1,2,3 \
  --langs py,c,cpp \
...
python cweval/generate_stage1_dream.py gen \
  --backend dream_multitask_ast \
  --model_path "${MTAST_BASE}/checkpoint-1500" \
  --codedllm_root "${CODEDLLM_ROOT}" \
  --eval_path evals/eval_multitask_ast_bigvul_cm_ckpt1500_n4_4gpu-dream_mtast_cweval \
  --ppt direct \
  --num_proc 4 \
  --gpu_ids 0,1,2,3 \
  --langs py,c,cpp \
